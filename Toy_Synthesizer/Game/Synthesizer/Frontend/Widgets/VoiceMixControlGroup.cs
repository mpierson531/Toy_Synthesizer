...
namespace Toy_Synthesizer.Game.Synthesizer.Frontend.Widgets
{
    public class VoiceMixControlGroup : GroupWidget
    {
        ...
        private void InitWidgets()
        {
            ...
            sliderDisplayWidget.OnWidgetValueChanged += SliderDisplayWidget_OnWidgetValueChanged;
        ...
        private void SliderDisplayWidget_OnWidgetValueChanged(double value)
        {
            SetVoiceMixRaw(value);
        }

        private void ParentVoiceGroup_OnVoiceChanged(VoiceGroup _, Voice previousVoice, Voice newVoice)
        {
            sliderDisplayWidget.SetWidgetValues(GetCurrentVoiceMix());
